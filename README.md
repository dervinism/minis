...
If you intend to use minis as a Python package, navigate to the minisPy folder and install the setup.py file (follow the instructions outlined inside the GettingStarted.html file; make sure you install Matlab R2020a Runtime before you complete the rest of the installation steps). However, prior to installing minisPy package you have to make sure that all required Python package dependencies are also installed. These are:\
python=3.7\
matlab\
pyabf
