...
% Complying with upper limit rise time constraint
Thr = 10;
if max(RTs) >= Thr
  constraints(7) = costFuncStruct.costBasis(iCostBasis) + costFuncStruct.costBasis(end-1);
  fitness = fitness + constraints(7);
end
